 ...
 * 2016-11-2
 */
public class FunctionInfoPower extends BaseInfo implements Serializable {
	
	private static final long serialVersionUID = 141892774617502630L;
	
	private String funciton_id;//按钮id
 	private String function_name;//按钮名称
	private String function_desc;
	private String parent_function_id;//父节点id
	private String remark;//描述
	private String function_seque;//是否有序
	...
	public String toString() {
		return "FunctionInfoPower [funciton_id=" + funciton_id
				+ ", function_name=" + function_name + ", function_desc="
				+ function_desc + ", parent_function_id=" + parent_function_id
				+ ", remark=" + remark + ", function_seque=" + function_seque
				+ ", status=" + status + ", create_person_id="
				+ create_person_id + ", create_person=" + create_person
				+ ", create_time=" + create_time + ", last_update_id="
				+ last_update_id + ", last_update_person=" + last_update_person
