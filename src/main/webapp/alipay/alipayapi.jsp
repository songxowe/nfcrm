...
<%@ page import="com.sd.farmework.services.util.alipay.config.AlipayConfig"%>
...
<html>
	...
	<%
		////////////////////////////////////请求参数//////////////////////////////////////
			...
			//建立请求
			String sHtmlText = com.sd.farmework.services.util.alipay.AlipaySubmit.buildRequest(sParaTemp,"get","确认");
